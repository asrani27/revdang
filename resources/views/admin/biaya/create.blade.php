...
<div class="p-6">
    ...
    <nav class="mb-4">
        <ol class="flex items-center gap-2 text-sm">
            ...
            <li class="text-slate-900 dark:text-white font-medium">Tambah Biaya</li>
        </ol>
    </nav>

    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Biaya Baru</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Tambahkan data biaya baru</p>
    </div>

    <!-- Form -->
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        <form action="{{ route('admin.data.biaya.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="kode" name="kode" value="{{ old('kode') }}" 
                        ...
                        placeholder="Masukkan kode biaya (contoh: B001)" required>
                    @error('kode')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" min="0"
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Keterangan bersifat opsional.</p>
                </div>
            </div>
