...
<div class="p-4 sm:p-6 lg:p-8 mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6 lg:mb-8">
        ...
        <div
            ...
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">156</p>
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <span
                    class="bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 text-xs font-semibold px-2.5 py-1 rounded-full">Pending</span>
            </div>
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">23</p>
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <span
                    class="bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-xs font-semibold px-2.5 py-1 rounded-full">Diproses</span>
            </div>
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">45</p>
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <span
                    class="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-xs font-semibold px-2.5 py-1 rounded-full">Selesai</span>
            </div>
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">88</p>
        ...
        <div
            ...
            <div class="px-5 py-4 lg:px-6 lg:py-5 border-b border-slate-200 dark:border-slate-700">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <h3 class="text-base lg:text-lg font-semibold text-slate-900 dark:text-white">Statistik Pengaduan
                    </h3>
                    <div class="flex items-center gap-2">
                        <select
                            class="text-sm bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-1.5 text-slate-600 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    ...
                    <div class="w-full max-w-md">
                        ...
                        <div class="flex items-end justify-between h-48 lg:h-56 gap-2 lg:gap-4 px-2">
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-400 rounded-t-lg transition-all duration-300"
                                    style="height: 60%"></div>
                                <span class="mt-2 text-xs text-slate-500 dark:text-slate-400">Jan</span>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-400 rounded-t-lg transition-all duration-300"
                                    style="height: 75%"></div>
                                <span class="mt-2 text-xs text-slate-500 dark:text-slate-400">Feb</span>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-400 rounded-t-lg transition-all duration-300"
                                    style="height: 45%"></div>
                                <span class="mt-2 text-xs text-slate-500 dark:text-slate-400">Mar</span>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-500 rounded-t-lg transition-all duration-300"
                                    style="height: 90%"></div>
                                <span class="mt-2 text-xs text-slate-500 dark:text-slate-400">Apr</span>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-500 rounded-t-lg transition-all duration-300"
                                    style="height: 65%"></div>
                                <span class="mt-2 text-xs text-slate-500 dark:text-slate-400">Mei</span>
                            </div>
                            <div class="flex-1 flex flex-col items-center">
                                <div class="w-full bg-yellow-500 rounded-t-lg transition-all duration-300"
                                    style="height: 55%"></div>
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            ...
                            <svg class="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1h-1a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
                            </svg>
                        </div>
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300">Dalam Pengerjaan</span>
                    </div>
                    <span class="text-lg font-bold text-slate-900 dark:text-white">2</span>
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div
                    ...
                    <span class="text-lg font-bold text-slate-900 dark:text-white">8</span>
                </div>

                <div class="pt-4 border-t border-slate-200 dark:border-slate-700">
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-semibold text-slate-600 dark:text-slate-400">Total Hari Ini</span>
                        <span class="text-xl font-bold text-yellow-500">18</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-4 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900 dark:text-white text-sm">#PND-2024-001</p>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Gangguan listrik di area Pelaihari</p>
                        </div>
                    </div>
                    <span
                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400">Pending</span>
                </div>
            </div>
            <div class="p-4 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900 dark:text-white text-sm">#PND-2024-002</p>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Meteran rusak di Jl. A. Yani</p>
                        </div>
                    </div>
                    <span
                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400">Diproses</span>
                </div>
            </div>
            <div class="p-4 space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-medium text-slate-900 dark:text-white text-sm">#PND-2024-003</p>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Pemadaman terjadwal di Kandangan</p>
                        </div>
                    </div>
                    <span
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="font-medium text-slate-900 dark:text-white">#PND-2024-001</span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-8 h-8 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center text-white text-xs font-semibold">
                                    AR</div>
                                <span class="text-sm text-slate-700 dark:text-slate-300">Ahmad Rijal</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">Gangguan listrik di
                                area Pelaihari</p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="font-medium text-slate-900 dark:text-white">#PND-2024-002</span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    DW</div>
                                <span class="text-sm text-slate-700 dark:text-slate-300">Dewi Wahyuni</span>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">Meteran rusak di Jl.
                                A. Yani</p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">Pemadaman terjadwal
                                di Kandangan</p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
