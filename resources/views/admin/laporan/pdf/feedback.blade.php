...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $f->pengaduan->pelanggan->nama ?? '-' }}</td>
                <td class="text-center">{{ $f->rating }} / 5</td>
                <td>{{ Str::limit($f->komentar, 50) }}</td>
    ...
    <div class="footer">
        <p>Total Data: {{ $feedback->count() }} | Sistem Rev Dang - Laporan {{ $title }}</p>
    </div>
</body>
</html>
