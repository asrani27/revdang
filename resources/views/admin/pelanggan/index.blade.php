                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @else
                                <a href="{{ route('admin.data.pelanggan.reset-password.show', $p->id) }}" class="p-2 text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-colors" title="Reset Password">
