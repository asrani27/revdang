...
@section('title', 'Buat Akun Petugas')
...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Buat akun user untuk petugas: {{ $petugas->nama }}</p>
    </div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-blue-700 dark:text-blue-400">Petugas ini belum memiliki akun user. Akun akan dibuat dengan role "Petugas".</p>
        </div>
    </div>

    <!-- Form -->
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        <form action="{{ route('admin.data.petugas.store-user', $petugas->id) }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-end gap-3 mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
                ...
                <button type="submit" class="px-6 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors text-sm font-medium">
                    Buat Akun
                </button>
            </div>
        </form>
