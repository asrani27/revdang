...
<div class="p-6">
    ...
    <nav class="mb-4">
        <ol class="flex items-center gap-2 text-sm">
            ...
            <li class="text-slate-900 dark:text-white font-medium">Tambah Petugas</li>
        </ol>
    </nav>

    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Petugas Baru</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Akun user akan dibuat otomatis dengan username: NIK dan password: <strong>petugas</strong></p>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        <form action="{{ route('admin.data.petugas.store') }}" method="POST">
            ...
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Data Petugas</h3>
