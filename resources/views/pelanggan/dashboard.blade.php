...
<div class="p-4 sm:p-6 lg:p-8 mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
        ...
        <div
            ...
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">{{ $sedangDiproses }}</p>
        ...
        <div
            ...
            <p class="text-3xl font-bold text-slate-900 dark:text-white mb-1">{{ $selesai }}</p>
    ...
    <div
        ...
        <div class="px-5 py-4 lg:px-6 lg:py-5 border-b border-slate-200 dark:border-slate-700">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <a href="{{ route('pelanggan.pengaduan.index') }}" class="text-sm text-yellow-600 dark:text-yellow-400 hover:text-yellow-700 dark:hover:text-yellow-300">
                    Lihat Semua →
                </a>
            </div>
        </div>
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-slate-500 dark:text-slate-400">Belum ada pengaduan</p>
            <a href="{{ route('pelanggan.pengaduan.create') }}" class="mt-4 inline-block text-yellow-600 dark:text-yellow-400 hover:text-yellow-700 dark:hover:text-yellow-300">
                Buat Pengaduan Baru →
            </a>
        </div>
        @else
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <p class="text-sm text-slate-600 dark:text-slate-400 max-w-xs truncate">{{ $item->keluhan }}</p>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right">
                            <a href="{{ route('pelanggan.pengaduan.show', $item->id) }}" class="p-2 text-slate-400 hover:text-yellow-500 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
